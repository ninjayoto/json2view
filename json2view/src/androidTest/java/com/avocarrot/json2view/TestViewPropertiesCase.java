    ...
    public void testPaddingOverrideValues() {
        View view = DynamicView.createView(
            ...
            dummyJsonObj
                ...
                .addProperty(new DynamicPropertyJsonBuilder().setName(NAME.PADDINGLEFT).setType(TYPE.DIMEN).setValue(4).build())
                .addProperty(new DynamicPropertyJsonBuilder().setName(NAME.PADDINGTOP).setType(TYPE.DIMEN).setValue(6).build())
                .addProperty(new DynamicPropertyJsonBuilder().setName(NAME.PADDINGRIGHT).setType(TYPE.DIMEN).setValue(8).build())
                .addProperty(new DynamicPropertyJsonBuilder().setName(NAME.PADDINGBOTTOM).setType(TYPE.DIMEN).setValue(10).build())
                .build(), pHandler);
